...
void main() => runApp(const MaterialApp(home: ObjectsOnPlanesWidget()));

class ObjectsOnPlanesWidget extends StatefulWidget {
  const ObjectsOnPlanesWidget({Key? key}) : super(key: key);
  @override
  ObjectsOnPlanesWidgetState createState() => ObjectsOnPlanesWidgetState();
}

class ObjectsOnPlanesWidgetState extends State<ObjectsOnPlanesWidget> {
    ...
    if (singleHitTestResult != null) {
      ...
      if (didAddAnchor!) {
        ...
        var newNode = ARNode(
            ...
            uri: "https://github.com/IgorKow/gITF/raw/main/apple.glb",
